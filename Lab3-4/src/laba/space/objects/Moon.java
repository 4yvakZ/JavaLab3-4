...
public class Moon extends SpaceObject implements OrbitalObject{
	...
	public void orbitInfo(){
		System.out.println(name + " имеет орбиту вокруг " + orbitCenter.toString() + " радиуса " + Integer.toString(orbit) + ".");
	}

	public boolean equals(Moon moon){
		if(radius == moon.getRadius() && name.equals(moon.getName()) && orbit == moon.getOrbit() && orbitCenter.equals(moon.getOrbitCenter())){
			return true;
		}
		return false;
	}
